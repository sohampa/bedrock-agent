...
This agent is a **security-only** code reviewer for CI and GitHub PR workflows. Unrelated or non-security questions are denied. See [docs/CODE_REVIEW.md](../../docs/CODE_REVIEW.md).
...
| `GITHUB_TOKEN` | For PR tools | PAT with repo + pull request access (or `GH_TOKEN`) |
